...
var libopenmpt = { memoryInitializerPrefixURL : "" };
...
ChiptuneJsPlayer.prototype.unlock = function() {
	...
	console.error(this.config.context);

	unlockSource.buffer = buffer;
	unlockSource.connect(this.config.audioDestination || context.destination);
...
ChiptuneJsPlayer.prototype.play = function(buffer) {
	...
	//processNode.connect(this.config.repeatCount,this.config.audioDestination || this.context.destination);
	processNode.connect(this.config.audioDestination || this.context.destination);
}
