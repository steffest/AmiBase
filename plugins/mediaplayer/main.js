...
let MediaPlayer = function(){
    ...
    var menu = [
        ...
        {label: "Radio",items:[
                ...
                {label: "Vuurland",action:function(){Player.playUrl("https://quantumcast.vrtcdn.be/stubru_tgs/mp3-128")}},
                {label: "StuBru",action:function(){Player.playUrl("https://vrt.streamabc.net/vrt-studiobrussel-mp3-128-4409118?sABC=673o4139%230%238pr6nq69p57rpqrs8nnoppp1r6084960%23")}},
